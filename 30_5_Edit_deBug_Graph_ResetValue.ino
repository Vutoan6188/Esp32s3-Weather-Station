...
void GraphWindRainSD() {
  ...
  for (int l = 80; l <= 800; l = l += 24) {
    tft.drawLine(l, 250, l, 350, 0x3186);
  }
  //Red line through 3 Graph
  for (int x = 80; x <= 780; x += 24) {
    tft.drawLine(x, 250, x, 350, 0x4228);
  }
  tft.drawLine(20, 270, 800, 270, 0x4228);
  tft.drawLine(20, 310, 800, 310, 0x4228);
  tft.setTextDatum(BL_DATUM);
...
void GraphTempSD() {
  ...
  for (int l = 80; l <= 800; l = l += 24) {
    tft.drawLine(l, 360, l, 410, 0x3186);
  }
  //Red line through 3 Graph
  for (int x = 80; x <= 780; x += 24) {
    tft.drawLine(x, 360, x, 410, 0x4228);
  }
  tft.setTextDatum(BL_DATUM);
  tft.setTextColor(TFT_LIGHTGREY, TFT_BLACK);
  tft.drawString("Temperature", 0, 367);
...
void GraphHumSD() {
  ...
  for (int l = 80; l <= 800; l = l += 24) {
    tft.drawLine(l, 420, l, 470, 0x3186);
  }
  //Red line through 3 Graph
  for (int x = 80; x <= 780; x += 24) {
    tft.drawLine(x, 420, x, 470, 0x4228);
  }
  tft.setTextDatum(BL_DATUM);
  tft.setTextColor(TFT_LIGHTGREY, TFT_BLACK);
  tft.drawString("Humidity", 0, 427);
