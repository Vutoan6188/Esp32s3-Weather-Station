...
void debugMemoryTFT(int baseY) {
  ...
  // Free Heap
  tft.fillRect(750, baseY + 1, 50, 8, 0x4228);
  tft.fillRect(750, baseY + 2, barHeap, 6, TFT_GREEN);

  // Min Heap
  tft.fillRect(750, baseY + 11, 50, 8, 0x4228);
  tft.fillRect(750, baseY + 12, barMin, 6, TFT_GREEN);

  // Largest Block
  tft.fillRect(750, baseY + 21, 50, 8, 0x4228);
  tft.fillRect(750, baseY + 22, barBlock, 6, TFT_GREEN);
}
