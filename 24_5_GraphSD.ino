...
*/
  ...
  snprintf(buf, sizeof(buf), "Heap : %u", freeHeap);
  tft.drawString(buf, 624, 70);

  snprintf(buf, sizeof(buf), "Min  : %u", minHeap);
  tft.drawString(buf, 624, 80);

  snprintf(buf, sizeof(buf), "Block: %u", largestBlock);
  tft.drawString(buf, 624, 90);
}
